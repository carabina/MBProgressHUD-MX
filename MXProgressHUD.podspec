#
#  Be sure to run `pod spec lint MXHUD-in-Objective-C.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/Meniny/MXProgressHUD-MX"
  ...
  s.source       = { :git => "https://github.com/Meniny/MXProgressHUD-MX.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "MXProgressHUD+MX/*"
  ...
  # s.resource  = "icon.png"
  # s.resources = "MXHUD-OC/MXHUD.bundle"
