...
@interface MBProgressHUD (Meniny)
...
+ (instancetype _Nonnull)makeHUD:(NSString * _Nonnull)text type:(MBProgressHUDType)type customIcon:(UIImage * _Nullable)icon view:(UIView * _Nullable)view;
